...
class Article(models.Model):
    ...
    text = models.TextField(verbose_name="Type your article", default="Text")
    creation_data = models.DateField(auto_now=True, auto_created=True)
    amount_upvotes = models.PositiveIntegerField(default=0, blank=True, null=True)
